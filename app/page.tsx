...
const subsidiaries = [
  ["Etcon Analytical & Environmental Systems Ltd", "Industrial, scientific and biomedical laboratory solutions.", "/logos/etcon-analytical.png", "https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=900&q=85"],
  ["Asset Matrix Energy Ltd", "Industrial Engineering Solutions", "/logos/asset-matrix-energy.png", "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?auto=format&fit=crop&w=900&q=85"],
  ["Vethanconcepts Ltd", "Conference & Exhibition event Management, Co-workspace facility.", "/logos/vethanconcepts.png", "https://images.unsplash.com/photo-1521737711867-e3b97375f902?auto=format&fit=crop&w=900&q=85"],
  ["Asset Matrix Automation Ltd", "Renewable, Automation, Robotics Engineering Solutions.", "/logos/asset-matrix-automation.png", "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=900&q=85"],
  ["Etcon Labs", "Laboratory Services", "/logos/etcon-labs.webp", "https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&w=900&q=85"],
  ["Perfect Events Retail & Consumer", "Event & Party Props, Retail & Wholesale .", "/logos/perfect-events.jpeg", "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?auto=format&fit=crop&w=900&q=85"],
];
...
const team = [
  ...
  ["Regina Imevbore", "Group Head, Creative Marketing & Strategic Communications", "/team/Regina%20Imevbore.PNG"],
    ...
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-content">
          ...
          <a className="button button-accent" href="#contact">Start a conversation <span>↗</span></a>
        </div>
        <div className="hero-footer"><span>01 — 03</span><span className="scroll-line" /> <span>Scroll to explore</span></div>
      </section>
      ...
      <section className="intro section-pad" id="about">
        ...
        <div className="intro-copy">
          ...
          <a className="text-link" href="#sectors">Explore subsidiaries <span>↗</span></a>
        </div>
      ...
      <section className="about-details section-pad" id="about-us">
        ...
        <div className="principle-list">
          <article className="principle-card"><span className="principle-icon">◎</span><div><h3>Our Mission</h3><p>At Vethan Concepts Group Limited, our mission is to deliver innovative, sustainable, and high-impact solutions that drive value for our clients, empower communities, and shape industries. We are committed to excellence in every endeavor, providing cutting-edge solutions across our diversified portfolio.</p></div></article>
          <article className="principle-card"><span className="principle-icon">↗</span><div><h3>Our Vision</h3><p>To be a globally recognized, multi-sector powerhouse, renowned for transforming ideas into lasting legacies, leading with integrity, and creating inclusive growth across all markets we serve.</p></div></article>
          <article className="principle-card"><span className="principle-icon">✦</span><div><h3>Our People / Our Culture</h3><p>Our people are the heartbeat of our success. We foster a culture of collaboration, creativity, and continuous growth, empowering talent and nurturing leadership at every level of the organization.</p></div></article>
        </div>
      </section>
      ...
      <section className="sectors section-pad" id="sectors">
        ...
        <div className="subsidiary-carousel" aria-label="VCGL subsidiaries">
          <div className="subsidiary-track">
            {[...subsidiaries, ...subsidiaries].map(([title, description, logo, image], index) => <a className="subsidiary-card" href="#contact" key={`${title}-${index}`}>
            ...
            <div className="subsidiary-card-body"><p className="card-category">VCGL subsidiary</p><h3>{title}</h3><p>{description}</p><span className="card-arrow">↗</span></div>
          </a>)}
          </div>
        </div>
      </section>
      ...
      <section className="contact section-pad" id="contact">
        ...
        <div className="contact-panel">
          ...
          <div className="contact-actions">
            ...
            <a className="button button-whatsapp" href="https://wa.me/2347041943795" target="_blank" rel="noreferrer">Send us a WhatsApp message <span>↗</span></a>
          </div>
          <div className="contact-footer">
            <a className="contact-email" href="mailto:info@vcgl.ng">info@vcgl.ng <span>↗</span></a>
            <p>Head Office: No. 23, House 13 Osogbo Street, Ogudu, Lagos.<br />Operational Office: 445 Herbert Macaulay Way, Yaba, Lagos State.</p>
          </div>
        </div>
      </section>

      <footer><a className="brand footer-brand" href="#top"><Image className="brand-logo" src="/vcgl logo.jpg" alt="VCGL - Vethan Concepts Group Ltd" width={150} height={50} /></a><span>Innovation across industries. Excellence without limits.</span><a href="#top">Back to top ↑</a></footer>
    </main>
  );
}
